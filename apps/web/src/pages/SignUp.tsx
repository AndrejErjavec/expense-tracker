      ...
      <div className="max-w-md rounded-2xl border border-stone-200 bg-white p-8 shadow-[0_14px_30px_rgba(28,26,22,0.12)]">
        ...
        <div className="mt-6 space-y-4">
          <div>
            ...
            <input className="mt-2 w-full rounded-lg border border-stone-200 px-3 py-2 text-sm" type="text" />
          </div>
          <div>
          ...
          <div>
            ...
            <input className="mt-2 w-full rounded-lg border border-stone-200 px-3 py-2 text-sm" type="password" />
          </div>
          <button className="w-full rounded-lg bg-stone-900 px-4 py-2 text-sm font-semibold text-white transition hover:bg-stone-800">
            Sign up
          </button>
        </div>
      </div>
